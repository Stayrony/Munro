...
namespace Munro.Common.Invoke
{
    public class BaseInvokeHandler<K> : IInvokeHandler<K>
    {
                                         ...
                                         Func<IInvokeResultSettings, IInvokeResultSettings> settingsFunc)
        {
            ...
            LogInvoke(invokeResult, settings.InvokeFunctionLogSettings);
        ...
        protected virtual void LogInvoke<T>(InvokeResult<T> result, InvokeFunctionLogSettings operationLogSettings)
        {
